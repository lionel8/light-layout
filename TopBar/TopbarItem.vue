<template>
  <div v-if="!item.hidden&&item.children" class="topbar-item-wrapper">
    ...
    <el-submenu v-else ref="submenu" :index="resolvePath(item.path)">
      ...
      <template v-for="child in item.children" v-if="!child.hidden">
        <topbar-item v-if="child.children&&child.children.length>0" :is-nest="true" :item="child" :key="child.path" :base-path="resolvePath(child.path)" class="nest-menu" />
